<!--
  PRD §9 designates README.md as the build specification itself.
  The specification follows verbatim below the divider; an unmodified copy is
  kept at docs/prd.md for traceability. This short block is the only addition.
-->
